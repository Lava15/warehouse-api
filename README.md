...
Clone the repository
    ...
    git clone https://github.com/Lava15/warehouse-api.git
...
Start the local with docker development server
...
The api can be accessed at [http://localhost/api](http://localhost:8000/api).
